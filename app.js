...
<thead>
    <tr style="background-color: #f8fafc;">
        ...
        <th class="col-stok">Stok Awal</th> 
...
<tbody>
    ...
    dataMasukFiltered.map((x, i) => {
        ...
        <tr>
            ...
            <td class="col-tgl">${formatTanggalIndo(x.tanggal)}</td>
            <td class="col-kode">${x.kode}</td>
            <td class="col-nama">${db.master.find(m => m.kode === x.kode)?.nama || 'Unknown'}</td>
            <td class="col-stok" align="center">${stokAwal}</td>
            <td class="col-qty" style="font-weight: bold; color: green;" align="center">+${x.qty}</td>
...
function exportTable(type) {
    ...
    // Perbaikan: Menambahkan table-layout: fixed agar kolom sejajar
    const styles = `
    <style>
    ...
    table { 
        ...
        width: 100%; 
        table-layout: fixed; /* Kunci agar kolom tetap sejajar */
        margin-bottom: 20pt; 
        min-width: 700px; /* Sedikit ditambah agar area konten lebih luas */
    }
    ...
    /* FIX: white-space: nowrap memastikan tanggal tampil 1 baris */
    ...
    .col-stok { width: 10%; }
    .col-qty { width: 8%; }
    .col-ket { width: 23%; } /* Sesuaikan agar total 100% */
